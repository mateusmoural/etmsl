...
<html>
  ...
  <title>Registra boletos liquidados - ETMSL</title>
    <meta charset="UTF-8" />
    <!-- Estilos da Index.php -->
    <link rel="stylesheet" id="bootstrap-css" href="../..//bootstrap.min.css">
      ...
      <div class="row" style="padding: 50px">
          ...
          <div class="login-form-2 col-12" style="min-width: 300px; background-color: #fff; padding: 50px;">
              ...
              *Action é vazia por que vamos fazer a validação e o redirecionamento nesta mesma página.
              ...
              <form method="post" action="../consultas/registrar_nota_.php" enctype="multipart/form-data">
                <div class="flex-box">
