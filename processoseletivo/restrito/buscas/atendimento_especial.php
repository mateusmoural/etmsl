...
<html lang="pt-br">
  <head>
    ...
    <link rel="icon" href="">
    <title>Requerentes de atendimento especial</title>
  ...
  <body>
    <div class="container">
      ...
      <div class="header clearfix">
        ...
        <h3 class="text-muted">Inscritos por curso</h3>
      </div>
      <div class="header clearfix">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div>
            <label for="EscCargo">ATENDIMENTO ESPECIAL</label>
    ...
    <script>
      $("#busca").change(function(){
        var busca = $("#busca").val();
                $.post('../consultas/atendimento_especial_.php', {busca: busca},function(data){
          $("#result").html(data);
        });
      });
