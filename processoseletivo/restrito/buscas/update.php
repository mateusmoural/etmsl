<?php 
	...
	header("Location: ../menu.php");
		...
		$_SESSION['status'] = 'confirma_alteracao';
}  
...
<head>
	...
	<script type="text/javascript">
	    ...
	    function h_email(){
	        if(document.getElementById('c_email').checked){
...
<div class="container">
	<div class="flex-box w-100 p-3" style=" background-color:#fff">
		<form action="../consultas/update_.php" method="post">
		...
		<div class="row">			 
			 <input type="text" class="form-control obrigatorio" name="nome" disabled id="nome">
		</div><br>

		<div class="row align-items-center">
			<div class="col col-2" >
				<input type="checkbox" name="c_cpf" id="c_cpf" onchange="h_cpf()" />
			</div>
			<div class="col col-10">
				<b>CPF:</b> <?php echo $v_cpf?>
			</div>
		</div>
		<div class="row">
			<input type="text" class="form-control obrigatorio" name="cpf" id="cpf" disabled maxlength="14" onkeyup="javascript: fMasc( this, mCPF );">
		</div><br>

		<div class="row align-items-center">
			<div class="col col-2" >
				<input type="checkbox" name="c_email" id="c_email" onchange="h_email()" />
			</div>
			<div class="col col-10">
				<b>E-MAIL:</b> <?php  echo $v_email?>
			</div>
		</div>
		<div class="row">
			<input type="email" class="form-control obrigatorio" name="email" id="email" disabled onkeyup="minuscula(this)">
		</div><br>

		<div class="row align-items-center">
			<div class="col col-2" >
				<input type="checkbox" name="c_nis" id="c_nis" onchange="h_nis()" />
			</div>
			<div class="col col-10">
				<b>NIS:</b> <?php echo $v_nis?>
			</div>
		</div>
		<div class="row">
			<input type="text" class="form-control obrigatorio" name="nis" id="nis" disabled maxlength="14">
		</div><br>
		...
		<div class="row align-items-center">
			...
			<div class="col col-10">
				<b>DATA DE NASCIMENTO:</b> <?php echo $v_dt_nasc?>
			</div>
		</div>
		<div class="row">
			<input type="text" class="form-control obrigatorio" name="dt_nasc" id="dt_nasc" maxlength="10" disabled onkeyup="javascript: fMasc( this, mData);">
		</div><br>
		...
		<div class="row align-items-center">
			<div class="col col-2" >
				<input type="checkbox" name="c_cep" id="c_cep" onchange="h_cep()" />
			</div>
			<div class="col col-10">
				<b>CEP:</b> <?php echo $v_cep?>
			</div>
		</div>
		<div class="row">
			<input type="text" class="form-control obrigatorio" name="cep" id="cep" disabled maxlength="9" onkeyup="javascript: fMasc( this, mCEP );" onblur="pesquisacep(this.value);">
		</div><br>
		...
		<div>
			<div class="row center-align">
				<div class="col-6 center-align"><button type="button" class="btn btn-info btn-block" id="voltar" onclick="window.location.href = 'para_atualizar.php'">Voltar</button>
				</div>
