...
class WebserviceCaixa {
	...
	function __construct($args = array()) {
		...
		$this->wsdl_consulta = $base_url . '/sibar/ConsultaCobrancaBancaria/Boleto?wsdl';
	...
	function Consulta($args) {
		...
		$xml_array = array(
			'sibar_base:HEADER' => array(
				...
				'IDENTIFICADOR_ORIGEM' => '177.128.224.246',
	 ...
	 */
	function GeraBoletoPHP($resposta, $args) {
		...
		$dadosboleto["nosso_numero"] = $this->GetNossoNumero();
	...
	function GetFlagAceite()         { return $this->resposta['DADOS']['CONSULTA_BOLETO']['TITULO']['FLAG_ACEITE']; }
