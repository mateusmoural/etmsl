<?php
  session_start();
  if ($_SESSION['status'] != 'logoninscricao') {
    ...
    //Possibilita acesso ao inscricaoregistrar.php
    $_SESSION['status'] = 'solicitar';
  }
...
<form id="regForm" action="registrar.php" method="post">
  ...
  <h2 class="lead">Solicitar inscrição online</h2>
