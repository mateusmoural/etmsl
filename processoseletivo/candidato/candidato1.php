...
// Inicia sessões 
  ...
  $sql = "SELECT id, cpf, nome, opcao_curso, dt_nasc, email, fone1, situacao, pagamento, classificacao, url, escolar_completa, link, link_matricula FROM processoseletivo WHERE cpf = '$cpf'";
  ...
  <div class="container">
    <div class="jumbotron"style="background-color:#fff">
      ...
      <?php  
        ...
        elseif ($situacao == "APROVADO QUARTA CHAMADA"){
      ...
      <div id="actions" class="row">
         <div class="col-md-12">
          <a href="candidato.php?sair=1" class="btn btn-default">Sair</a>
         </div>
      </div>   
    </div>
  </div>
