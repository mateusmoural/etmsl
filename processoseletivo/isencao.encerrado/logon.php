...
if($cpfok == 1 && $num == 0 && $contagoogle <>'' && $linha == 0 && $n == 11) {
	...
	echo "Prossiga clicando no botão Solicitar isenção.<br>";
	...
	if($n == 11){
		...
		echo "Já existe inscrição para este CPF.<br>";
			...
			//Verifica se CPF é válido
			if($cpfok==1){
				echo "<br>Certo! CPF válido.<br>";
			}
			else{
				echo "<br>Opa! Número de CPF inválido.<br>";
			}
		}
	}
	else{
		echo "<br>Opa! Número de CPF incompleto.<br>";
	}
