...
<html>
  ...
  <title>Logon - ETMSL</title>
    ...
    <meta name="google-signin-client_id" content="89860467480-pv7fv03svg5mvg030eelr1tc2tosob36.apps.googleusercontent.com">
    ...
    <div class="container login-container flex-box">
      <div class="row">
          ...
          <div class="login-form-2 col-12" style="min-width: 300px;">
              <h1>Logon para formulário de isenção de taxa do processo seletivo</h1>
              <!-- Aqui temos o formulário
              *Action é vazia por que vamos fazer a validação e o redirecionamento nesta mesma página.
              -->
              <hr>
              <p>Para iniciar o processo, é necessário efetuar login com sua própria <font color="red" size=5;><b>conta Google (Gmail)</b></font>, que será vinculada ao seu número de CPF.<br>Esse procedimento é essencial para acesso à plataforma da prova.</p>
              ...
              <form method="post" action="isencao.php">
              ...
              <p id="result" style="color: red;"></p>
                ...
                <p class="flex-box">
                  <a style="margin: 5px;" href="../index.php" class="btn btn-info btn-lg">Voltar</a>  <button  style="margin: 5px;" type="submit" id="botao" class="btn btn-success btn-lg" disabled="true">Solicitar isenção</button>
                </p>               
            </form>
          </div>
      </div>
